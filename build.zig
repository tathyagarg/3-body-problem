...
pub fn build(b: *std.Build) !void {
    ...
    const screen_width = b.option(u32, "screen_width", "Screen width for the application") orelse 1200;
    const screen_height = b.option(u32, "screen_height", "Screen height for the application") orelse 800;
